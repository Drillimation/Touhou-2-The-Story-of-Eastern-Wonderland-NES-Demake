...
draw_set_alpha(1);
draw_sprite(spr_magic_stone_05,stone[0],24,24);
draw_sprite(spr_magic_stone_05,stone[1],56,16);
draw_sprite(spr_magic_stone_05,stone[2],136,16);
draw_sprite(spr_magic_stone_05,stone[3],168,24);
draw_self();
